        ...
        <div class="card-body">
            <form id="roleForm" action="{{ route('dashboard.roles.store') }}" method="POST">
                ...
                <div class="form-group">
                    <label for="roleName" class="font-weight-bold text-gray-700 small">Nama Peran</label>
                ...
                <div class="row mb-3">
                    @foreach ($groupedPermissions as $group => $permissions)
                        <div class="col-md-2 mb-3">
                            <h6 class="font-weight-bold text-uppercase border-bottom pb-1 mb-2 text-primary" style="font-size:.78rem;">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-hover w-100" id="table-roles">
                    <thead>
    ...
    <script>
        $(document).ready(function () {
            ...
            const table = $('#table-roles').DataTable({
                ...
                serverSide: true,
                responsive: false,
                ajax: { url: "{{ route('dashboard.roles.index') }}", type: 'GET' },
                language: {
            ...
            $(document).on('click', '.editRole', function () {
                ...
                // Simulasi delay kecil agar loading terasa
                setTimeout(() => {
                    Swal.close();
                    ...
                    // Pre-fill checkbox permission
                    $('.perm-check').prop('checked', false);
                    if (permissions && permissions.length) {
                        permissions.forEach(pid => $('#perm_' + pid).prop('checked', true));
                    }
                    ...
                    $('html, body').animate({ scrollTop: $('#roleForm').offset().top - 80 }, 300);
                }, 400);
            });
