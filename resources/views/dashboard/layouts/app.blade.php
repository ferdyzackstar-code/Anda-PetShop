                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div
                                ...
                                <a
                                    class="dropdown-item text-center small text-gray-500" href="#">Show All
                                    Alerts</a>
                                </div>
                            </li>
                                ...
                                <a class="dropdown-item d-flex align-items-center"
                                    ...
                                    <div>
                                        <div class="text-truncate">Last month's
                                            report looks great, I am very happy with
                                ...
                                <a class="dropdown-item d-flex align-items-center"
                                    ...
                                    <div>
                                        <div class="text-truncate">Am I a good
                                            boy? The reason I ask is because someone
                                            told me that people say this to
                                            all dogs, even if they aren't good...</div>
                                        <div class="small text-gray-500">
                                            Chicken the Dog · 2w</div>
                                        </div>
                                    </a>
                                <a
                                    class="dropdown-item text-center small text-gray-500" href="#">Read More
                                    Messages</a>
                                </div>
                            </li>
