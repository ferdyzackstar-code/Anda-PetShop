...
@section('title', 'Laporan Harian — Anda Petshop')
...
@section('content')
    ...
    <div class="card w-100 border-0 shadow-sm mb-3">
        <div class="card-body py-3 px-4 bg-primary rounded d-flex flex-wrap align-items-center justify-content-between">
            <h5 class="mb-0 text-white font-weight-bold">
                <i class="fas fa-calendar-day mr-2"></i> Laporan Transaksi Harian
            </h5>
            @php
                $exportUrl = route(
                    'dashboard.reports.daily.export',
                    array_filter([
    ...
    <div class="card w-100 border-0 shadow-sm mb-3">
        <div class="card-body p-3">
            <div class="d-flex align-items-center">
                ...
                <span class="font-weight-bold text-primary ml-2">Laporan Harian</span>
            </div>
        </div>
    </div>
    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <i class="fas fa-table mr-1"></i> Rincian Laporan Harian
            </h6>
        </div>
